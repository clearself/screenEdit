						...
						<div v-for="(item,index) in data" :key="index">
							...
							<div v-else class="list-item right">
								<div class="right-contemt right">
									...
									<div v-if="item.msgType==0" class="message right" :class="{'myMessage':item.isMyMessage}" style="background-color:#0a5968;"><i></i><p class="right">{{item.msg}}</p></div>
									<div v-if="item.msgType==3" class="message right" style="background-color:#0b5a6b;"><i></i><p class="right"><img :src="item.msg" alt="表情" /></p></div>
